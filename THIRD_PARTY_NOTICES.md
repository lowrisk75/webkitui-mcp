...
WebKitUI MCP 0.6.5 Developer Preview is built from the Swift package in this
...
with macOS. Those frameworks are not redistributed in the package and remain
subject to Apple's applicable terms.

The repository also contains private JavaScript compatibility fixtures and
